...
pub fn convert_assets_to_shares(assets_amount: u64, total_shares: u64, total_assets_amount: u64, round_up: bool) -> u64 {
    let result;
    if total_assets_amount == 0 {
        ...
        let numerator = match round_up {
            // ceil rounding
            // result = assets_amount * total_shares + total_assets_amount - 1 / total_assets_amount
            true => assets_amount_u128 * total_shares_u128 + total_assets_amount_u128 - 1,

            // floor rounding
            // result = assets_amount * total_shares / total_assets_amount
            false => assets_amount_u128 * total_shares_u128,
        };

        let result_u128 = numerator / total_assets_amount_u128;
